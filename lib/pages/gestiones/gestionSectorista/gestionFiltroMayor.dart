...
class GestionFMSecPage extends StatefulWidget {
  final int value;
  final String nombre;
  final String imagen;
  ...
  @override
  _GestionFMSecPageState createState() => _GestionFMSecPageState();
}

class _GestionFMSecPageState extends State<GestionFMSecPage> {
  ...
  _getData() async {
    ...
    // print(apiToken);
    final url =
        "$urlGlobal/api/filtroMayor/sectorista/${widget.value}?api_token="+apiToken;
    print(url);
    ...
    if (response.statusCode == 200) {
        final directory = await getApplicationDocumentsDirectory();
        final fileData = File('${directory.path}/pag-gestiones-gestionSectorista-gestionFiltroMayor${widget.value}.json');
