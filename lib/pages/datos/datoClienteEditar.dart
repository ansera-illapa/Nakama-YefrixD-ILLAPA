...
class DatoClienteEditarPage extends StatefulWidget {
  final String imagen;
  final String nombre;
  ...
  @override
  _DatoClienteEditarPageState createState() => _DatoClienteEditarPageState();
}

class _DatoClienteEditarPageState extends State<DatoClienteEditarPage> {
  int contDireccion = 0;
  int contTelefonos = 0;
  int contCorreos = 0;
  ...
  _getDatosCliente() async{
    ...
    final url =
        "$urlDato/clienteDatos/${widget.clienteId}/${widget.socioId}?api_token="+apiToken;
    print(url);
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            _buildSectorSelccionado('SECTOR SELECCIONADO', 
                                                    sectorSeleccionado, 
                                                    sectorNombre)
                    ...
                    Wrap(
                          children: <Widget>[
                            for(var cont =0; cont < cantSectores; cont++ )
                              dataSectores[cont]['id'] == sectorSeleccionado
...
//_handlePressButton
  ...
  _actualizarCliente() async{
    ...
    final response = await http.post(url, body: {
                    ...
                    "sectorId":  "$codSectorSeleccionado",
