...
class DatFreeNuevoPage extends StatefulWidget {
  final int estatus;
  final String nombre;
  ...
  @override
  _DatFreeNuevoPageState createState() => _DatFreeNuevoPageState();
}

class _DatFreeNuevoPageState extends State<DatFreeNuevoPage> {
  int contDireccion = 1;
  int contTelefonos = 1;
  int contCorreos = 1;
  ...
  _getSectores() async {
    ...
    final url =
        "$urlDatFree/sectoresTodos/${widget.socioId}?api_token="+apiToken;
    print(url);
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          if(widget.estatus == 0)
                            _buildClienteAsociado("Jose Luis Bustamante y Riveyro"),
                      ...
                      child: Column(
                        children: <Widget>[
                          if(widget.estatus == 0)
                            ...
                            _buildListDatosCliente(contTelefonos, 
                                                    'Telefonos', 2, 
                                                    telefonosList, 
                                                    'PREFIJO', 
                                                    'TIPO', 'NUMERO', 
...
_agregarCliente() async{
    ...
    print("CANTIDAD");
    print("DIRECIONES: "+"$cantDirecciones");
                    ...
                    // mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text('¿Estás seguro de agregar este nuevo cliente?', style: TextStyle(color: Colors.white, fontFamily: 'illapaBold', fontSize: 20.0, ), textAlign: TextAlign.center,),
                        ),
