...
class DatFreeMapsPage extends StatefulWidget {
  ...
  @override
  _DatFreeMapsPageState createState() => _DatFreeMapsPageState();
}

class _DatFreeMapsPageState extends State<DatFreeMapsPage> {
  
  CameraPosition _initialPosition = CameraPosition(target: LatLng(-12.752720620680945, -76.62098150700331), zoom: 10);
